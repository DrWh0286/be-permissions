...
namespace SebastianHofer\BePermissions\Form\Element;
...
final class IdentifierField extends AbstractFormElement
{
     ...
     *
     * @return string[][] As defined in initializeResultArray() of AbstractNode
     */
    public function render()
    {
        ...
        $mainFieldHtml[] =          '<input readonly type="' . $inputType . '" ' . GeneralUtility::implodeAttributes($attributes, true) . ' />';
        ...
        if (!empty($valuePickerHtml) || !empty($valueSliderHtml) || !empty($fieldControlHtml)) {
            ...
            $mainFieldHtml[] =              implode(PHP_EOL, $valuePickerHtml);
            $mainFieldHtml[] =              implode(PHP_EOL, $valueSliderHtml);
        ...
        $mainFieldHtml[] =  '</div>';
        $mainFieldHtml[] = '</div>';
        $mainFieldHtml = implode(PHP_EOL, $mainFieldHtml);
        ...
        if ($this->hasNullCheckboxButNoPlaceholder()) {
            ...
            $fullElement[] = '</div>';
            $fullElement[] = $mainFieldHtml;
            $fullElement = implode(PHP_EOL, $fullElement);
