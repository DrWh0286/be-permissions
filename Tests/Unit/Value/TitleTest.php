...
final class TitleTest extends UnitTestCase
{
     ...
     * @test
     */
    public function can_be_created_from_database_value_and_returned_as_configuration_value(): void
    {
        $dbValue = 'Group title';
     ...
     * @test
     */
    public function can_be_created_from_configuration_value_and_returned_as_database_value(): void
    {
     ...
     * @test
     */
    public function with_empty_database_field_an_empty_title_is_returned(): void
    {
     ...
     * @test
     */
    public function field_name_is_title(): void
    {
     ...
     * @test
     */
    public function title_is_not_changed_by_extend(): void
    {
